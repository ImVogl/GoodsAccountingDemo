...
public class ApiClient
{
     ...
     */
    public UserInfo signin(String login, String password) throws ApiClientException, ApiUnauthorizeException {
        ...
        if (response.unautorized()){
            throw new ApiUnauthorizeException();
        }

        throw new ApiClientException(response.get_exception());
    }
     ...
     */
    public boolean signout(int id) throws ApiUnauthorizeException, ApiClientException
    {
    ...
    public boolean refreshToken(){
        ...
        if (response.get_exception() == null){
            ...
            tokenResponse.Token = response.get_response();
            _accessService.saveJWT(tokenResponse);
            return true;
        };
