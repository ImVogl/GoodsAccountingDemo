...
describe('Get categories tests.', () => {
    const activeCatFruitsFirst: IGoodsItemDto = {category: "Fruits", id: "1", name: "Apple", r_price: 10, w_price: 10, active: true, storage: 10 };
    const activeCatVegetablesFirst: IGoodsItemDto = {category: "Vegetables", id: "2", name: "Carrot", r_price: 10, w_price: 10, active: true, storage: 10 };
    const activeCatVegetablesSecond: IGoodsItemDto = {category: "Vegetables", id: "3", name: "Cabbage", r_price: 10, w_price: 10, active: true, storage: 10 };
    const notActiveCatFruits: IGoodsItemDto = {category: "Fruits", id: "4", name: "Watermellow", r_price: 10, w_price: 10, active: false, storage: 10 };
    const notActiveCatVegetables: IGoodsItemDto = {category: "Vegetables", id: "5", name: "Сucumber", r_price: 10, w_price: 10, active: false, storage: 10 };
    const activeCatFruitsSecond: IGoodsItemDto = {category: "Fruits", id: "6", name: "Cantaloupe", r_price: 10, w_price: 10, active: true, storage: 10 };
    const activeCatVegetablesThree: IGoodsItemDto = {category: "Vegetables", id: "7", name: "Potatos", r_price: 10, w_price: 10, active: true, storage: 10 };
